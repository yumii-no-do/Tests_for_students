...
class Settings extends React.Component {
    ...
    handleUpdate() {
        ...
        this.props.getThemes();
        // console.log(this.state.selectQuestion)
                ...
                : <div style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap' }}>
                    <AppBar style={{ display: 'flex', justifyContent: 'center', }} position="static" color="default">
                        ...
                        <Tabs
                            ...
                            scrollButtons="auto"
                        >
                            <Tab label="Темы" key={1} />
                            <Tab label="Группы" key={2} />
                            <Tab label="Настройка приложения" key={3} />
                        </Tabs>
                    </AppBar>
                    <Paper style={{ overflowX: 'auto', width: '100%', margin: 24, marginTop: 48, maxWidth: 1500, height: 'calc(100vh - 168px )', }}>
                        {/* <div className={classNames(classes.tableHeader)}>
                            <Typography variant="subtitle1" component="span" color="secondary">header</Typography>
                        </div> */}
                        <div style={{ display: 'flex', height: '100%', height: '100%', }}>
                            <div className='border-rigth' style={{ flexGrow: 1, maxWidth: '20%', overflow: 'auto', }}>
                                ...
                                <div className='panel-container'>
                                    ...
                                    {
                                        // JSON.stringify(this.props.themes)
                                            ...
                                            <FormControl component="fieldset" style={{ flexGrow: 1, width: '100%' }}>
                                                ...
                                                >

                                                    {
                                                        ...
                                                        //     return (
                                                        //         <FormControlLabel value={index} key={index} control={<Radio />} label={item} />
                                                        //     )
                                                        // })
